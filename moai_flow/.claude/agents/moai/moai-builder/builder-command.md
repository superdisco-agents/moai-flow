...
**Before creating any command**, this gate checks for existing SPECs and offers auto-generation:
...
│ 2. Check command dir for SPEC-REF.md    │
│                                         │
│ Found? → Load SPEC, proceed to Phase 1  │
│                                         │
│ Not Found? → AskUserQuestion:           │
│   "Create SPEC for this command?"       │
│   [Yes, create SPEC] [No, skip SPEC]    │
│                                         │
│ If Yes:                                 │
│   • Auto-generate minimal SPEC          │
│   • Store in .moai/specs/SPEC-CMD-{ID}  │
│   • Create SPEC-REF.md in command dir   │
...
**Command Frontmatter Traceability** (11-section structure):
```yaml
---
description: {description}
# SPEC-First Traceability
spec_id: SPEC-CMD-{ID}        # or "none" if skipped
...
- [ ] **T**est-first: SPEC exists before command creation
- [ ] **R**eadable: REQ IDs mapped to implementation
- [ ] **U**nified: Single source in .moai/specs/
- [ ] **S**ecured: No secrets in SPEC or command
