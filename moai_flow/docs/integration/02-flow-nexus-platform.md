# MoAI-Flow Platform Platform

> Cloud-based orchestration and execution platform

## Overview

MoAI-Flow Platform is MoAI-Flow's cloud platform providing 70+ advanced MCP tools. It offers sandboxed execution, templates, cloud storage, and more. **This is optional for MoAI** and requires registration.
...
| Feature | MoAI-Flow Platform | MoAI |
|---------|------------|------|
...
### Option 1: Add MoAI-Flow Platform MCP
...
| MoAI-Flow Platform | MoAI Local Alternative |
|------------|------------------------|
...
- Use MoAI-Flow Platform for specific cloud needs
- Best of both worlds
...
MoAI-Flow Platform is optional for most use cases.

### When to Use MoAI-Flow Platform
...
| Aspect | With MoAI-Flow Platform | Without (Local) |
|--------|-----------------|-----------------|
...
MoAI-Flow Platform provides powerful cloud features that extend MoAI-Flow's capabilities. However, MoAI's local-first architecture has its own strengths. For most development workflows, MoAI's local approach is sufficient. MoAI-Flow Platform integration should be considered only for specific cloud needs like sandboxed execution of untrusted code or cloud collaboration. Local alternatives (Docker, builder agents, local storage) can address most needs without external dependencies.
