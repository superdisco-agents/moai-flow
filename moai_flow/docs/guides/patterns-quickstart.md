...
1. **Read patterns.md** - Comprehensive documentation in [patterns.md](../modules/patterns.md)
2. **Check example_usage.py** - Complete examples in `moai_flow/patterns/example_usage.py`
3. **Run tests** - `pytest moai_flow/tests/test_pattern*.py -v`
4. **Explore API** - See API Reference in [patterns.md](../modules/patterns.md)

## Support

- Documentation: [patterns.md](../modules/patterns.md)
- Examples: `moai_flow/patterns/example_usage.py`
- Tests: `moai_flow/tests/test_pattern*.py`
