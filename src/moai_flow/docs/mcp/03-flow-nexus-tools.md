# MoAI-Flow Platform MCP Tools

> 70+ cloud-based orchestration tools (Advanced Features)

## Overview

MoAI-Flow Platform is MoAI-Flow's cloud platform providing 70+ advanced MCP tools. These are **optional** features requiring registration.
...
```bash
# Register for MoAI-Flow Platform
...
### If Adding MoAI-Flow Platform to MoAI
...
| Aspect | With MoAI-Flow Platform | Without |
|--------|-----------------|---------|
...
MoAI-Flow Platform provides advanced features but adds:
- External dependency
...
MoAI-Flow Platform is a powerful cloud extension but requires careful consideration of trade-offs. MoAI's local-first approach has different strengths. Integration is optional based on specific needs.
