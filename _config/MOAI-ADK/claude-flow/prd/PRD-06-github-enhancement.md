...
Claude-Flow has 9 specialized GitHub agents. MoAI has 1 (manager-git) plus basic GitHub MCP. This limits automation for PR workflows, issue management, and repository analysis.
...
### Claude-Flow GitHub Capabilities
...
- [Claude-Flow GitHub Agents](../agents/06-github-repository.md)
