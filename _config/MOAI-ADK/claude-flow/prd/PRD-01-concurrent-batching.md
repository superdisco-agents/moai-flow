...
> Implement Claude-Flow's concurrent execution patterns in MoAI
...
MoAI users often execute operations sequentially when parallel execution would be more efficient. Claude-Flow's "Golden Rule" of concurrent batching significantly improves performance.
...
- [ ] CLAUDE.md contains Rule 11 with concurrent batching guidance
...
- [Claude-Flow Concurrent Execution](../core/01-concurrent-execution.md)
