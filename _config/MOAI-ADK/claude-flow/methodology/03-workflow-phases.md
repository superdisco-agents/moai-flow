...
```bash
npx claude-flow sparc run spec-pseudocode "Project description"
```
...
### Claude-Flow Execution
```bash
npx claude-flow sparc run architect "System description"
```
...
### Claude-Flow Execution
```bash
npx claude-flow sparc run integration "Integration description"
```
...
**Claude-Flow**: 5 explicit phases, each with dedicated commands
