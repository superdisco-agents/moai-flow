...
SPARC is Claude-Flow's systematic development methodology that breaks down complex tasks into 5 distinct phases.
...
Claude-Flow provides specific modes for each phase:
