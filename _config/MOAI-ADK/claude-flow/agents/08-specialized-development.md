...
Claude-Flow has 8 specialized development agents. These map well to MoAI's expert tier agents.
...
| Claude-Flow | MoAI Equivalent | Match Level |
|-------------|-----------------|-------------|
...
MoAI has additional experts not in Claude-Flow:

| MoAI Agent | Purpose | Claude-Flow Equivalent |
|------------|---------|------------------------|
