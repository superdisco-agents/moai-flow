...
Claude-Flow includes extensive GitHub integration with 9 specialized agents and dedicated MCP tools. **MoAI has basic GitHub support** through the standard GitHub MCP server.

---

## Claude-Flow GitHub Agents
...
### Option 1: Add Claude-Flow GitHub Tools
...
Access Claude-Flow's GitHub tools alongside MoAI.
...
Full GitHub agent ecosystem matching Claude-Flow.
