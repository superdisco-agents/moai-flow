...
MoAI has basic session hooks (SessionStart, SessionEnd) but lacks fine-grained operation hooks for tasks, agents, and file operations. MoAI-Flow's comprehensive hook system provides granular control at every operation level.
