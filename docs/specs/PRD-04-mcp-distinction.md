...
Users and agents may confuse MCP tool capabilities with agent execution. MoAI-Flow explicitly distinguishes these:
...
**Status**: Implemented
**Date**: 2025-11-29
**Location**: `/CLAUDE.md` Rule 12
**Documentation**: Rule 12 (MCP vs Task Distinction) added to CLAUDE.md with comparison tables and correct usage patterns.
