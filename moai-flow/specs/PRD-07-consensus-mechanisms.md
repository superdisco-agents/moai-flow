...
MoAI-Flow has 7 consensus-related agents implementing various consensus algorithms (Byzantine, Raft, Gossip, etc.). MoAI has no consensus mechanisms, limiting multi-agent decision-making.
...
### Option A: MoAI-Flow Consensus MCP

Use MoAI-Flow's consensus via MCP:
...
mcp__moai-flow__consensus_propose {
