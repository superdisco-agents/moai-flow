...
MoAI-Flow includes 7 agents for distributed systems consensus - protocols borrowed from distributed computing for multi-agent coordination. MoAI has NO equivalent.
