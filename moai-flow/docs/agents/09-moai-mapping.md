# MoAI-Flow to MoAI Agent Mapping

> Complete mapping between 54 MoAI-Flow agents and 56 MoAI agents

## Overview

This document provides a comprehensive mapping to help translate MoAI-Flow patterns to MoAI equivalents.
...
| No Match (CF→MoAI) | 24 | MoAI-Flow unique |
...
## MoAI-Flow Unique (24) - No MoAI Equivalent
...
## MoAI Unique (20) - No MoAI-Flow Equivalent
...
### MoAI-Flow Should Consider (From MoAI)
...
### For MoAI Migration
1. Map existing MoAI-Flow workflows to MoAI commands
